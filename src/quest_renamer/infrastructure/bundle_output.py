...
def write_build_report(
    ...
    *,
    ...
    report = {
        ...
        "notes": [
            "The Android application ID and matching expansion-file paths were changed.",
            "Java class names were kept so native code, reflection, and layouts still resolve.",
